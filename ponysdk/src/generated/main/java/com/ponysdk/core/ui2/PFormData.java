...
public class PFormData extends PObject2 {
    ...
    public void append(String name, PBlob value){
    }

    public void append(String name, PBlob value, String filename){
    }
    ...
    public PFormDataEntryValue get(String name) {
       return null;
    }


    public PFormDataEntryValue[] getAll(String name) {
       return null;
    }
    ...
    public void set(String name, PBlob value){
    }

    public void set(String name, PBlob value, String filename){
    }
