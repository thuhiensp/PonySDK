...
public class PUint8Array extends PArrayBufferView {
    public PUint8Array(Double length){
      super(length);
    }

    public PUint8Array(PUint8Array array){
      super(array);
    }

    public PUint8Array(Byte[] array){
      super(array);
    }

    public PUint8Array(PArrayBuffer buffer){
      super(buffer);
    }

    public PUint8Array(PArrayBuffer buffer, Double byteOffset){
      super(buffer, byteOffset);
    }

    public PUint8Array(PArrayBuffer buffer, Double byteOffset, Double length){
    ...
    protected PLeafTypeWithArgs widgetWithArgs() {
      return PLeafTypeWithArgs.UINT8_ARRAY;
    }
    ...
    public void set(PUint8Array array){
    }

    public void set(Byte[] array){
    }

    public void set(PUint8Array array, Double offset){
    }
    ...
    public PUint8Array subarray(Double begin) {
       return null;
    }


    public PUint8Array subarray(Double begin, Double end) {
       return null;
    }
