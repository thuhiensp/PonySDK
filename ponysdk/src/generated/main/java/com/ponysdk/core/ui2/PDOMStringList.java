...
public class PDOMStringList extends PObject2 {
    private PDOMStringList(){
    }
    ...
    public void contains(final Consumer<Boolean> cback,String string){
       cbacksSequence++;
       cbacks.put(cbacksSequence, cback);
       final ModelWriter writer = UIContext.get().getWriter();
       writer.beginPObject2();
       writer.write(ServerToClientModel.POBJECT2_METHOD, getID());
       writer.write(ServerToClientModel.POBJECT2_NUM_METHOD, PMethodNames.CONTAINS_TYPESTRING_BOOLEAN.getValue());
