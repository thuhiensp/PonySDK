...
public class PWorker extends PEventTarget {
    private static final Logger log = LoggerFactory.getLogger(PWorker.class);
    public PWorker(String scriptUrl){
      super(scriptUrl);
    }
    ...
    protected PLeafTypeWithArgs widgetWithArgs() {
      return PLeafTypeWithArgs.WORKER;
    }
