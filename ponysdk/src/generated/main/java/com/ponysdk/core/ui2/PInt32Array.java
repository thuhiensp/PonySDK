...
public class PInt32Array extends PArrayBufferView {
    ...
    public void set(PInt32Array array){
    }

    public void set(Double[] array){
    }

    public void set(PInt32Array array, Double offset){
    }
    ...
    public PInt32Array subarray(Double begin) {
       return null;
    }


    public PInt32Array subarray(Double begin, Double end) {
       return null;
    }
