...
public class PHTMLFrameSetElement extends PHTMLElement {
    private static final Logger log = LoggerFactory.getLogger(PHTMLFrameSetElement.class);
    public PHTMLFrameSetElement() {
    }

    public void setCols(final String cols)  {
       setAttribute(PAttributeNames.COLS_STRING, cols);
       log.info("cols" + cols);
    }
    public void setRows(final String rows)  {
       setAttribute(PAttributeNames.ROWS_STRING, rows);
       log.info("rows" + rows);
    }
    ...
    public String getCols(){
      return (String) getAttribute(PAttributeNames.COLS_STRING);
    }
    public String getRows(){
      return (String) getAttribute(PAttributeNames.ROWS_STRING);
    }
    ...
    protected PLeafTypeNoArgs widgetNoArgs() {
      return PLeafTypeNoArgs.HTML_FRAME_SET_ELEMENT;
    }
    ...
    public PWindow2 get(String name) {
       return null;
    }
