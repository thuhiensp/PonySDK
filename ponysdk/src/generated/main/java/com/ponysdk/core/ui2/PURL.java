...
public class PURL extends PObject2 {
    private static final Logger log = LoggerFactory.getLogger(PURL.class);
    public PURL(String url){
      super(url);
    }

    public PURL(String url, String base){
      super(url, base);
    }
    ...
    protected PLeafTypeWithArgs widgetWithArgs() {
      return PLeafTypeWithArgs.URL;
    }


    public void createObjectURL(final Consumer<String> cback,PBlob blob){
    }

    public void createObjectURL(final Consumer<String> cback,PMediaSource source){
    }

    public void createObjectURL(final Consumer<String> cback,PMediaStream stream){
    }
    ...
    public void revokeObjectURL(String url){
       ...
       REVOKE_OBJECTURL_TYPESTRING_VOID.getValue());
