...
public class PInputEvent extends PUIEvent {
    public PInputEvent(final Map<PEventAttributesName, Object> mapValueByAttributeName){
       super(mapValueByAttributeName);
    }

    public Object getData(){
      return get(PEventAttributesName.DATA_STRING);
    }
    public Object getIsComposing(){
      return get(PEventAttributesName.IS_COMPOSING);
    }
    public Object getInputType(){
      return get(PEventAttributesName.INPUT_TYPE);
    }
