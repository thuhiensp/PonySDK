...
public class PCustomElementRegistry extends PObject2 {
    private PCustomElementRegistry(){
    }
    ...
    public void define(String name, PFunction constructor){
    }

    public void define(String name, PFunction constructor, PElementDefinitionOptions options){
    }
    ...
    public PPromise<Void> whenDefined(String name) {
       return null;
    }
