...
public class PNetworkInformation extends PEventTarget {
    ...
    public void setOntypechange(final PEventHandlerNonNull ontypechange, final PEventAttributesName... atrsEventName)  {
       setAttribute(PAttributeNames.ONTYPECHANGE, new AttributeCallBack(ontypechange, atrsEventName));
       log.info("ontypechange" + ontypechange.getClass().getName());
    }
    ...
    public PEventHandlerNonNull getOntypechange(){
      return (PEventHandlerNonNull) getAttribute(PAttributeNames.ONTYPECHANGE);
    }
