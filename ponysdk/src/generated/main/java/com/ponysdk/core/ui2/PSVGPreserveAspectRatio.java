...
public class PSVGPreserveAspectRatio extends PObject2 {
    ...
    private PSVGPreserveAspectRatio(){
    }

    public void setAlign(final Short align)  {
       setAttribute(PAttributeNames.ALIGN_SHORT, align);
       log.info("align" + align);
    }
    public void setMeetOrSlice(final Short meetOrSlice)  {
       setAttribute(PAttributeNames.MEET_OR_SLICE, meetOrSlice);
       log.info("meetOrSlice" + meetOrSlice);
    }

    public Short getAlign(){
      return (Short) getAttribute(PAttributeNames.ALIGN_SHORT);
    }
    public Short getMeetOrSlice(){
      return (Short) getAttribute(PAttributeNames.MEET_OR_SLICE);
    }
