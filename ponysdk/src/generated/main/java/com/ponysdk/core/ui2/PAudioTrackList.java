...
public class PAudioTrackList extends PEventTarget {
    private static final Logger log = LoggerFactory.getLogger(PAudioTrackList.class);
    private PAudioTrackList(){
    }
    ...
    public PAudioTrack get(Double index) {
       return null;
    }


    public PAudioTrack getTrackById(String id) {
       return null;
    }
