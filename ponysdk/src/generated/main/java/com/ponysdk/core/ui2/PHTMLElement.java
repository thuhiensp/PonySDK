...
public abstract class PHTMLElement extends PElement {
    private static final Logger log = LoggerFactory.getLogger(PHTMLElement.class);
     protected PHTMLElement() {
     }
    protected PHTMLElement(final Object...argOfConstructor){
    ...
    public void setTranslate(final Boolean translate)  {
       setAttribute(PAttributeNames.TRANSLATE, translate);
    ...
    public void setNonce(final String nonce)  {
       setAttribute(PAttributeNames.NONCE, nonce);
    ...
    public Boolean getTranslate(){
      return (Boolean) getAttribute(PAttributeNames.TRANSLATE);
    }
    ...
    public Double getTabIndex(){
      return (Double) getAttribute(PAttributeNames.TAB_INDEX);
    }
    public Boolean getInert(){
      return (Boolean) getAttribute(PAttributeNames.INERT);
    }
    public String getAccessKey(){
      return (String) getAttribute(PAttributeNames.ACCESS_KEY);
    }
    public Boolean getDraggable(){
      return (Boolean) getAttribute(PAttributeNames.DRAGGABLE);
    }
    public Boolean getSpellcheck(){
      return (Boolean) getAttribute(PAttributeNames.SPELLCHECK);
    }
    public String getContentEditable(){
      return (String) getAttribute(PAttributeNames.CONTENT_EDITABLE);
    }
    public String getInputMode(){
      return (String) getAttribute(PAttributeNames.INPUT_MODE);
    }
    public String getInnerText(){
      return (String) getAttribute(PAttributeNames.INNER_TEXT);
    }
    public String getOuterText(){
      return (String) getAttribute(PAttributeNames.OUTER_TEXT);
    }
    ...
    public String getNonce(){
      return (String) getAttribute(PAttributeNames.NONCE);
    }
