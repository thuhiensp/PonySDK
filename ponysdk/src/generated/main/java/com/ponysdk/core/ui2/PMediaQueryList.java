...
public class PMediaQueryList extends PEventTarget {
    private static final Logger log = LoggerFactory.getLogger(PMediaQueryList.class);
    private PMediaQueryList(){
    }
    ...
    public void addListener(PEventListener listener){
    }

    public void removeListener(PEventListener listener){
    }
