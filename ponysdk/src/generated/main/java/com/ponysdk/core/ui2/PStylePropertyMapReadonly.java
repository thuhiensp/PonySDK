...
public abstract class PStylePropertyMapReadonly extends PObject2 {
     protected PStylePropertyMapReadonly() {
     }
    protected PStylePropertyMapReadonly(final Object...argOfConstructor){
       super(argOfConstructor);
    }



    public PCSSStyleValue get(String property) {
       return null;
    }


    public PCSSStyleValue[] getAll(String property) {
       return null;
    }
    ...
    public void has(final Consumer<Boolean> cback,String property){
       cbacksSequence++;
