...
public class PSVGFEMorphologyElement extends PSVGElement {
     private PSVGAnimatedString in1;
     private PSVGAnimatedEnumeration operator;
     private PSVGAnimatedNumber radiusX;
     private PSVGAnimatedNumber radiusY;
    ...
    public PSVGFEMorphologyElement() {
    ...
    public PSVGAnimatedNumber getRadiusX(){
      return radiusX;
    }
    public PSVGAnimatedNumber getRadiusY(){
      return radiusY;
    }
    ...
    private PLeafTypeNoArgs widgetNoArgs() {
      return PLeafTypeNoArgs.SVGFE_MORPHOLOGY_ELEMENT;
    }
