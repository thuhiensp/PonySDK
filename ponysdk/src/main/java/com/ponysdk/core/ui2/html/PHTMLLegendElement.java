...
public class PHTMLLegendElement extends PHTMLElement {
    private static final Logger log = LoggerFactory.getLogger(PHTMLLegendElement.class);
     private PHTMLFormElement form;
     private String align;

    public PHTMLLegendElement() {
    ...
    private PLeafTypeNoArgs widgetNoArgs() {
      return PLeafTypeNoArgs.HTML_LEGEND_ELEMENT;
    }
