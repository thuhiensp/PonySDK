...
public class PRTCDTMFToneChangeEvent extends PEvent {
    public PRTCDTMFToneChangeEvent(final Map<PEventAttributesName, Object> mapValueByAttributeName){
       super(mapValueByAttributeName);
    }

    public Object getTone(){
      return get(PEventAttributesName.TONE);
    }
