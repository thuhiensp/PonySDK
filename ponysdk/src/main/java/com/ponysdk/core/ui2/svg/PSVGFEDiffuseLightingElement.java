...
public class PSVGFEDiffuseLightingElement extends PSVGElement {
     private PSVGAnimatedString in1;
     private PSVGAnimatedNumber surfaceScale;
     private PSVGAnimatedNumber diffuseConstant;
    ...
    public PSVGFEDiffuseLightingElement() {
    ...
    public PSVGAnimatedNumber getDiffuseConstant(){
    ...
    private PLeafTypeNoArgs widgetNoArgs() {
      return PLeafTypeNoArgs.SVGFE_DIFFUSE_LIGHTING_ELEMENT;
    }
