...
public class PSharedWorkerGlobalScope extends PWorkerGlobalScope {
    private static final Logger log = LoggerFactory.getLogger(PSharedWorkerGlobalScope.class);
     private String name;
     private PEventHandlerNonNull onconnect;

    public PSharedWorkerGlobalScope() {
    ...
    private PLeafTypeNoArgs widgetNoArgs() {
      return PLeafTypeNoArgs.SHARED_WORKER_GLOBAL_SCOPE;
    }
