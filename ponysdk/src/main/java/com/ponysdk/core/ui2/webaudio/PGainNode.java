...
public class PGainNode extends PAudioNode {
     private PAudioParam gain;

    public PGainNode(PBaseAudioContext context){
      applyInit(widgetWithArgs(), new Object[]{context});
    }

    public PGainNode(PBaseAudioContext context, PGainOptions options){
    ...
    private PLeafTypeWithArgs widgetWithArgs() {
      return PLeafTypeWithArgs.GAIN_NODE;
    }
