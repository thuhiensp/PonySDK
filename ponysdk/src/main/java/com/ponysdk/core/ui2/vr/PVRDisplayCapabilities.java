...
public class PVRDisplayCapabilities extends PObject2 {
     private Boolean hasPosition;
     private Boolean hasExternalDisplay;
     private Boolean canPresent;
     private Double maxLayers;

    public PVRDisplayCapabilities() {
    ...
    public Double getMaxLayers(){
      return maxLayers;
    }

    private PLeafTypeNoArgs widgetNoArgs() {
      return PLeafTypeNoArgs.VR_DISPLAY_CAPABILITIES;
    }
