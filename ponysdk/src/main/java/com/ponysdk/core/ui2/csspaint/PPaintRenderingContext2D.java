 ...
 * the License.
 */
package com.ponysdk.core.ui2.csspaint;
...
public class PPaintRenderingContext2D extends PObject2 {
    private static final Logger log = LoggerFactory.getLogger(PPaintRenderingContext2D.class);
    ...
    public PPaintRenderingContext2D() {
    ...
    private PLeafTypeNoArgs widgetNoArgs() {
      return PLeafTypeNoArgs.PAINT_RENDERING_CONTEXT2D;
    }
