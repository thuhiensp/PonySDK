...
public class PPresentationAvailability extends PEventTarget {
    private static final Logger log = LoggerFactory.getLogger(PPresentationAvailability.class);
     private Boolean value;
     private PEventHandlerNonNull onchange;

    public PPresentationAvailability() {
    ...
    private PLeafTypeNoArgs widgetNoArgs() {
      return PLeafTypeNoArgs.PRESENTATION_AVAILABILITY;
    }
