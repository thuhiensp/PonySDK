...
public class PWorkerPerformance extends PEventTarget {
    private static final Logger log = LoggerFactory.getLogger(PWorkerPerformance.class);
     private PEventHandlerNonNull onresourcetimingbufferfull;
     private PMemoryInfo memory;

    public PWorkerPerformance() {
    ...
    private PLeafTypeNoArgs widgetNoArgs() {
      return PLeafTypeNoArgs.WORKER_PERFORMANCE;
    }
