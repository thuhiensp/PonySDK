...
public class PAbstractWorker extends PObject2 {
    private static final Logger log = LoggerFactory.getLogger(PAbstractWorker.class);
     private PEventHandlerNonNull onerror;

    public PAbstractWorker() {
    ...
    private PLeafTypeNoArgs widgetNoArgs() {
      return PLeafTypeNoArgs.ABSTRACT_WORKER;
    }
