...
public abstract class PSVGElement extends PElement {
    private static final Logger log = LoggerFactory.getLogger(PSVGElement.class);
     ...
     private PSVGSVGElement ownerSVGElement;
     private PSVGElement viewportElement;
    ...
    public PSVGSVGElement getOwnerSVGElement(){
      return ownerSVGElement;
    }
    public PSVGElement getViewportElement(){
