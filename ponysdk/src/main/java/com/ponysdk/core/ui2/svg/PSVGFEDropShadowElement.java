...
public class PSVGFEDropShadowElement extends PSVGElement {
     private PSVGAnimatedString in1;
     private PSVGAnimatedNumber dx;
     private PSVGAnimatedNumber dy;
     private PSVGAnimatedNumber stdDeviationX;
     private PSVGAnimatedNumber stdDeviationY;
    ...
    public PSVGFEDropShadowElement() {
    ...
    public PSVGAnimatedNumber getDx(){
      return dx;
    }
    public PSVGAnimatedNumber getDy(){
      return dy;
    }
    public PSVGAnimatedNumber getStdDeviationX(){
      return stdDeviationX;
    }
    public PSVGAnimatedNumber getStdDeviationY(){
    ...
    private PLeafTypeNoArgs widgetNoArgs() {
      return PLeafTypeNoArgs.SVGFE_DROP_SHADOW_ELEMENT;
    }
